...
class PVMQwen3VLTextConfig(PretrainedConfig):
    r"""
    ...
    Args:
        ...
        # --- 🚨 新增参数说明 ---
        pvm_layers (`list[int]`, *optional*, defaults to `None`):
            The list of layer indices where the PVM (Persistent Visual Memory) block should be added.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # --- 🚨 PVM STATE 🚨 ---
        self.pvm_hidden_size = pvm_hidden_size
        self.pvm_layers = pvm_layers
        # ------------------------
...
class PVMQwen3VLConfig(PretrainedConfig):
    r"""
    ...
    model_type = "qwen3_vl"
    sub_configs = {"vision_config": Qwen3VLVisionConfig, "text_config": PVMQwen3VLTextConfig}
...
__all__ = ["PVMQwen3VLConfig", "PVMQwen3VLTextConfig"]
